...
L["how many cigorettes have you got lad"]={{path="chatsounds/autoadd/random_shit/how many cigorettes have you got lad.ogg",length=3.878}}
...
L["im dying"]={{path="chatsounds/autoadd/random_shit/im dying.ogg",length=0.915}}
...
L["investigate 311"]={{path="chatsounds/autoadd/random_shit/investigate 311.ogg",length=1.464}}
